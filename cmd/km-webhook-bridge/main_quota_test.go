...
// main_quota_test.go — Task 9A (Phase 121 follow-up): wire the Handler
// quota/freeze fields from env. WireActionQuota gates on KM_QUOTA_TABLE (empty
// ⇒ dormant; set ⇒ Quota/Limits/Freezer/QuotaTable all populated). Mirrors
// cmd/km-h1-bridge/main_quota_test.go.
