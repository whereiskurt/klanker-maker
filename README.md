...
> [!NOTE]
> Hihi! I'm [KPH](https://www.linkedin.com/in/kurthundeck/) and this project has been really useful for me building [defcon.run.34](https://github.com/whereiskurt/defcon.run.34) and [klanker-voice](https://github.com/whereiskurt/klanker-voice/). It's currently a protoype `pre-v1.0.0` which means it has a lot of "vibes" and "abandonded paths." But! I've been writing software for +30-years and and working w/ Claude+friends has been amazing. 🤗  
