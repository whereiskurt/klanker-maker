...
systemctl daemon-reload
systemctl enable km-http-proxy km-audit-log km-tracing km-presence km-mail-poller km-slack-inbound-poller
systemctl restart km-http-proxy km-audit-log km-tracing km-presence km-mail-poller km-slack-inbound-poller
