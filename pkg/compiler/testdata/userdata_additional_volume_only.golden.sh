...
export KM_ALLOWED_SENDERS="self:*@sandboxes.klankermaker.ai"
EOF
...
Environment=SANDBOX_ID=test-sb
Environment=KM_ARTIFACTS_BUCKET=my-bucket
Environment=KM_ALLOWED_SENDERS=self:*@sandboxes.klankermaker.ai
