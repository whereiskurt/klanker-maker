...
KM_SANDBOX_ID={{ .SandboxID }} KM_VOLUMES_ON_MISMATCH={{ .VolumeMismatchPolicy }} \
  /opt/km/bin/km-volumes mount{{ range .AdditionalVolumeMounts }} --fallback {{ .MountPoint }}:{{ .DeviceLetter }}{{ end }} \
