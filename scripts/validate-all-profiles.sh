...
#
# Validates every concrete leaf profile in the 28-entry Profile Inventory using
...
# leaf + 1 Phase 127 MITM intercepts demo leaf + 1 Phase 132 exec-capture UAT
# leaf (vulnhunt) + 8 pkg/profile/builtins entries + 10 GPU leaves (7 serving
# profiles + 3 Qwen3.8-oblit variants).
#
