...
**Requirements:** BOOTSTRAP-PREFLIGHT-BUCKET-CHECK, BOOTSTRAP-DRYRUN-TEXT-FIX, ENV-CONFIG-DRIFT-WARN, BOOTSTRAP-AUTO-IMPORT-EXISTING-DNS, PLAN-FRESH-INSTALL-OUTPUTS-HANDLING, THIRD-INSTALL-UAT (synthetic IDs — derived from the six problems surfaced in the post-84.2 second-install UAT)
