...
**Plans:** not yet planned — 5 waves proposed in the design spec § Wave breakdown
(1 config+profile plumbing, 2 B-side enrollment, 3 A-side register, 4 full create path +
capacity-in-B, 5 teardown + doctor + docs + live UAT).
