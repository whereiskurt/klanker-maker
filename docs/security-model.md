...
**Diagrams.** Seven single-file HTML diagrams live in
...
trust boundary, the IMDS fence as a pair of policy traces, and two on how the
Terraform/Terragrunt layer is actually invoked. Open any of them in a browser.
