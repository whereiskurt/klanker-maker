...
- `~/.ssh/config` — the managed `Host <alias> km-<alias> <sandbox-id> km-<sandbox-id>` block already points
...
Host mybox km-mybox lrn2-abc123 km-lrn2-abc123
  HostName localhost
  Port 2222
  User sandbox
